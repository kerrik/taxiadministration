...
$youtubeinfo = new CYoutubeinfo();

//fyller $tango med lite data att skriva ut...

$tango->set_property('title', "Hämta youtubeinfo");
$tango->set_property('title_append', "ett testprojekt för tangoweb.info");
...
$tango->set_property('main', <<<EOD
        <form action="" method = 'POST'>
            ...
            <br>
            <input name = 'Submit_URL' type="submit" value="Fetch data">
        </form>  
        Title video : {$youtubeinfo->title()}
